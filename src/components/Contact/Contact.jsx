...
const Contact = () => {
  ...
  <a
    href="mailto:prachiagarwal26092003@gmail.com"
    className="bg-[#0d081f] border border-gray-700 rounded-2xl p-6 text-center hover:border-[#8245ec] transition"
  >
    <h3 className="text-[#8245ec] text-xl font-semibold">
      Email
    </h3>
